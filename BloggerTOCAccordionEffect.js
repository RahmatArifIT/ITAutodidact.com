 ...
 * -------------------------------------------------
 * By : IT Autodidact
 * URL: https://www.itautodidact.com/
 * -------------------------------------------------
 **/
...
var toc_config = {
	...
	showNew: 15,
	newText: ' <strong style="font-weight:normal;font-style:normal;color:#FFFFFF;font-size:11px;background:#006600;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;">New</strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
